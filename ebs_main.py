...
if __name__ == '__main__':
    ...
    data, data_grid, derivatives, cfg, params, b_conds = tasks[title]()
    ...
    for variance in cfg.params["global_config"]["variance_arr"]:
        ...
        set_solutions, models = solver_equations(cfg, params, b_conds, equations, epde_search_obj, title)

        conf_plt.confidence_region_print(data, data_grid, cfg, params, set_solutions, variance, title)
