...
def solver_equations(config_solver, params, b_conds, equations, epde_obj=False, title=None):
    ...
    for equation in equations:
        ...
        if not b_conds:
            ...
            eq_s = transform.solver_view(equation, config_solver, reverse=config_solver.params["glob_solver"]["reverse"]) # eq_s = eq_g.solver_form() # not working with new version solver
